...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Апр 10 2023 г., 18:53
...
ALTER TABLE `items`
  ...
  ADD KEY `FK_Vendors_Items` (`FID_Vendor`),
  ADD KEY `FK_Category_Items` (`FID_Category`);
...
--
ALTER TABLE `items`
  ADD CONSTRAINT `FK_Category_Items` FOREIGN KEY (`FID_Category`) REFERENCES `category` (`ID_Category`),
  ADD CONSTRAINT `FK_Vendors_Items` FOREIGN KEY (`FID_Vendor`) REFERENCES `vendors` (`ID_Vendors`);
COMMIT;
